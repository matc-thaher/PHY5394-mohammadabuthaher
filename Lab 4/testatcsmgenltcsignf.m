...
sigVec1 = atcsmgenltcsignf1(timedata1,[t_a, t_a + L], A,[f_0,f_1], phase);
% Generate the signal for time data 2
sigVec2 = atcsmgenltcsignf1(timedata2,[t_a, t_a + L], A,[f_0,f_1], phase);
...
xlabel("Time in sec")
ylabel("s(t)")
title("Linear Transient Chirp Signal (Nyquist frequency = 1/2 * Maximum Frequency)")
